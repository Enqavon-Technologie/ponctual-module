export const fr = {
  ...
  profilePage: {
    ...
    tabs: {
      requests: "Mes Demande de garde",
      requestsTitle: "Mes demande de garde",
      cmg: "CMG",
      invoices: "Factures",
    ...
    interviews: {
      ...
      sectionTitle: "Vos entretiens",
      sectionSubtitle: "Vos candidates et rendez-vous",
    ...
    cmg: {
      title: "CAF Numéro allocataire",
      subtitle: "Renseigner votre numéro allocataire CAF.",
      fieldLabel: "CAF Numéro allocataire",
      placeholder: "ex. abc123456",
      submit: "Enregistrer",
      updateSuccess: "Numéro CAF mis à jour avec succès",
      description: "Votre numéro allocataire est important pour la transmission de vos données de garde afin d'avoir vos remboursements CAF.",
    },
    support: {
      title: "Avez-vous besoin d'assistance sur vos documents ?",
      subtitle: "Nous sommes disponible 24 H sur 24 et 7 J sur 7 pour vous aider",
  ...
  contract: {
    ...
    actions: {
      ...
      congrats: {
        title: "Félicitations !!!",
        subtitle: "Veuillez signer votre contrat et payer votre facture pour confirmer la réservation",
        ok: "Ok"
      }
    },
